...
public class TruncateSelector<T extends Individual> extends Selector<T> {
	private int index = 0;
	...
	public static void main(String args[]) {
		...
		Selector<Individual> selector = new TruncateSelector<Individual>(population, Selector.NORMAL);
		...
		selector.init(population, Selector.NORMAL);
		System.out.println(selector.getRandomPType());
		System.out.println(selector.getRandomPType());
		System.out.println(selector.getRandomPType());
		System.out.println(selector.getRandomPType());
